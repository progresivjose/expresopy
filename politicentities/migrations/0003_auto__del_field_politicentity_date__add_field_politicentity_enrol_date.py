...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PoliticEntity.date'
        db.delete_column(u'politicentities_politicentity', 'date')

        # Adding field 'PoliticEntity.enrol_date'
        db.add_column(u'politicentities_politicentity', 'enrol_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PoliticEntity.date'
        db.add_column(u'politicentities_politicentity', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 15, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'PoliticEntity.enrol_date'
        db.delete_column(u'politicentities_politicentity', 'enrol_date')
    ...
    models = {
        ...
        u'politicentities.politicentity': {
            ...
            'enrol_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
