...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticEntity.departure_date'
        db.add_column(u'politicentities_politicentity', 'departure_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticEntity.departure_date'
        db.delete_column(u'politicentities_politicentity', 'departure_date')
    ...
    models = {
        ...
        u'politicentities.politicentity': {
            ...
            'departure_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
