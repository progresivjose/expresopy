...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'entities_entitytype', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entitytype_to_user', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'entities', ['EntityType'])
        ...
        db.create_table(u'entities_entity', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_to_user', to=orm['auth.User'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'entities_entitytype')
