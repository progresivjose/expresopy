...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.entitytype'
        db.add_column(u'entities_entity', 'entitytype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='entity_to_entitytype', to=orm['entities.EntityType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.entitytype'
        db.delete_column(u'entities_entity', 'entitytype_id')
