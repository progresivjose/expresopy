...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blogs_blog', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='blog_owner', to=orm['auth.User'])),
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blog_owner'", 'to': u"orm['auth.User']"}),
