...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'editorial_editorial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('summary', self.gf('django.db.models.fields.TextField')()),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='editorial_owner', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'editorial', ['Editorial'])


    def backwards(self, orm):
        # Deleting model 'Editorial'
        db.delete_table(u'editorial_editorial')
    ...
    models = {
        ...
        u'editorial.editorial': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'editorial_owner'", 'to': u"orm['auth.User']"}),
