...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Politic'
        db.create_table(u'politics_politic', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='politic_to_user', to=orm['auth.User'])),
            ('political_party', self.gf('django.db.models.fields.related.ForeignKey')(related_name='politic_to_politicalparty', to=orm['politicalparties.PoliticalParty'])),
        ))
        db.send_create_signal(u'politics', ['Politic'])


    def backwards(self, orm):
        # Deleting model 'Politic'
        db.delete_table(u'politics_politic')
