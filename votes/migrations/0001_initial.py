...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'votes_vote', (
            ...
            ('politic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='votes_to_politic', to=orm['politics.Politic'])),
    ...
    models = {
        ...
        u'votes.vote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'politic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes_to_politic'", 'to': u"orm['politics.Politic']"}),
