...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PoliticFile'
        db.create_table(u'politicfiles_politicfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('mymetype', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('politic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='politicfile', to=orm['politics.Politic'])),
        ))
        db.send_create_signal(u'politicfiles', ['PoliticFile'])


    def backwards(self, orm):
        # Deleting model 'PoliticFile'
        db.delete_table(u'politicfiles_politicfile')
    ...
    models = {
        ...
        u'politicfiles.politicfile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'mymetype': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
